namespace AoC.Solutions.Year2018.Day22
{
    using System;
    using static Day22.Part02;

    public class Map
    {
        public Map((int X, int Y) targetLocation, int depth, int[,] erosionLevels, int[,] riskLevels)
        {
            this.TargetLocation = targetLocation;
            this.Depth = depth;
            this.ErosionLevels = erosionLevels;
        ...
        public static Map FromInput(string input, int padding = 0)
        {
            ...
            return new Map(target, depth, erosionLevels, riskLevels);
        }

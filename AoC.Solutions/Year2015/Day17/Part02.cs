namespace AoC.Solutions.Year2015.Day17
{
    using System;
    ...
    public class Part02 : ISolution
    {
        public string Solve(string input)
        {
            ...
            int minimumContainers = availableCombinations.Min(x => x.Count);

            return availableCombinations.Count(x => x.Count == minimumContainers).ToString();
        }
